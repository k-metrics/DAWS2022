...
```{r}
#| fig-cap: "元データ（点線：左）と加算データ（破線：右）"
curve(dnorm(x, mean = 4, sd = 2), -3, 15,
      lty = 3, xlab = "", ylab = "")
abline(v = 4, lty = 3)
curve(dnorm(x, mean = 8, sd = 2), -3, 15, add = TRUE,
      lty = 2, xlab = "", ylab = "")
abline(v = 8, lty = 2)
```
...
```{r}
#| fig-cap: "元データ（点線：左）と乗算データ（破線：右）"

curve(dnorm(x, mean = 4, sd = 2), -3, 15,
      lty = 3, xlab = "", ylab = "")
abline(v = 4, lty = 3)
curve(dnorm(x, mean = 8, sd = 4),
      -3, 15, add = TRUE, lty = 2,
      xlab = "", ylab = "")
abline(v = 8, lty = 2)
```
