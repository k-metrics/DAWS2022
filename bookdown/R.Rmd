...
```{r, fig.cap="階級をフリードマン・ダイアコニスの選択で求めた場合"}
...
![貯蓄現在高階級別世帯分布（出典：なるほど統計学園）](https://www.stat.go.jp/naruhodo/img/picture/4_8_10.png)
...
```{r, include=FALSE}
h <- with(x, hist(height, breaks = c(140, 150, 155, 160, 165, 170), plot = FALSE))
```
