...
```{r}
curve(dnorm(x, mean = 4, sd = 2), -3, 15, lty = 3,
      xlab = "", ylab = "")
abline(v = 4, lty = 3)
curve(dnorm(x, mean = 8, sd = 2), -3, 15, add = TRUE, lty = 2,
      xlab = "", ylab = "")
abline(v = 8, lty = 2)
```
...
```{r}
curve(dnorm(x, mean = 4, sd = 2), -2.581, 14.581, lty = 3,
      xlab = "", ylab = "")
abline(v = 4, lty = 3)
curve(dnorm(x, mean = 8, sd = 4), -2.581, 14.581, add = TRUE, lty = 2,
      xlab = "", ylab = "")
abline(v = 8, lty = 2)
```
